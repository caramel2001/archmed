import re
from transformers import AutoTokenizer, AutoModelForQuestionAnswering, AutoModel, AutoModelForSeq2SeqLM
import torch
...
def getAnswer(question, large_context, dir):
  ...
  tokenizer, model = getModel_QNA(name, dir)
